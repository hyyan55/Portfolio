        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className={`pointer-events-auto flex items-center justify-between gap-3 px-4 py-3 rounded-xl shadow-xl text-sm font-medium border ${
                toast.type === 'success'
                  ? 'bg-zinc-900 border-emerald-500/40 text-emerald-300'
                  : toast.type === 'error'
                  ? 'bg-zinc-900 border-rose-500/40 text-rose-300'
                  : 'bg-zinc-900 border-sky-500/40 text-sky-300'
              }`}
            >
